...
| item | 201 | 65 | 528 |
| block | 36 | 49 | 264 |
| block_entity | 1 | 20 | 157 |
| entity | 0 | 0 | 8 |
| menu | 1 | 2 | 55 |
| sound | 62 | 0 | 62 |
| recipe_serializer | 0 | 11 | 17 |
| recipe_type | 0 | 8 | 13 |
...
| P06 其余发电机 | M11 | 进行中 | 太阳能、地热、半流质已接入并验证；水力、风力、同位素、转换机及平衡配置待验收。 |
| P07 泵与采矿 | M11 | 待开始 | 泵、矿机、高级矿机；区块边界、液体源、钻头、管道和过滤。 |
| P08 存储与辅助机器 | M11 | 待开始 | 储罐、箱子、充电站、分拣机、交易机、个人保护、传送与磁化。 |
| P09 金属及高阶加工 | M11 | 进行中 | 金属成型三模式、工具箱合成链及洗矿机多输出／水事务已验证；铁栅栏、离心、回收和感应炉待迁移。 |
