...
public class Ic2SoundEvents {
    ...
    public static final SoundEvent ITEM_TREETAP_ELECTRIC_USE =
            register("item.treetap.electric.use");
    ...
    public static final SoundEvent GENERATOR_GEOTHERMAL_LOOP =
            register("generator.geothermal.loop");
    ...
    public static final SoundEvent MACHINE_ELECTROLYZER_LOOP =
            register("machine.electrolyzer.loop");
    public static final SoundEvent MACHINE_EXTRACTOR_OPERATE =
            register("machine.extractor.operate");
    ...
    public static final SoundEvent MACHINE_MACERATOR_OPERATE =
            register("machine.macerator.operate");
    ...
    public static final SoundEvent MACHINE_TELEPORTER_CHARGE =
            register("machine.teleporter.charge");
