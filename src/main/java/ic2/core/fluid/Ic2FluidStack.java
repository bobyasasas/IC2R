...
public interface Ic2FluidStack {
    ...
    default String getFluidTypeKey() {
        return this.isEmpty() ? null : this.getFluid().getFluidType().getDescriptionId();
    }

    default Component getFluidDisplayName() {
        return this.isEmpty() ? Component.empty() : this.getFluid().getFluidType().getDescription();
    }
    ...
    boolean hasExactFluid(Ic2FluidStack fluidStack);
