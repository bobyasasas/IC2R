...
public final class IndustrialCraft {
    ...
    public IndustrialCraft(IEventBus modBus, ModContainer container) {
        ...
        ic2.neoforge.interop.ae2.Ic2Ae2Plugin.init();
        gameBus.addListener(ic2.neoforge.interop.ae2.Ic2Ae2Plugin::onBlockPlaced);
        gameBus.addListener(ic2.neoforge.interop.ae2.Ic2Ae2Plugin::onBlockBroken);
        ...
        gameBus.addListener(ic2.neoforge.item.QuantumArmorHelper::onPlayerTick);
        gameBus.addListener(ic2.neoforge.item.JetpackLogic::onPlayerTick);
        gameBus.addListener(ic2.neoforge.item.UtilityArmorHelper::onPlayerTick);
        gameBus.addListener(ic2.neoforge.item.NightVisionHelper::onPlayerTick);
        gameBus.addListener(ic2.neoforge.item.JetpackAttachmentHelper::onPlayerTick);
