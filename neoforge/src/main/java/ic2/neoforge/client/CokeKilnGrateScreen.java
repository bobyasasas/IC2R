...
/** Tank-style screen for the kiln grate; clicking the gauge moves fluid with the cursor stack. */
public final class CokeKilnGrateScreen extends MachineScreen {
    public CokeKilnGrateScreen(MachineMenu menu, Inventory inventory, Component title) {
    ...
    public void extractBackground(
        ...
        graphics.text(
                font,
                Component.literal(menu.tankAmount(false) + " / 64000 mB"),
                leftPos + 44,
                topPos + 38,
                0xff404040,
                false);
