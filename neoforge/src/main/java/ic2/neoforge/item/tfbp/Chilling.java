...
/** Legacy Chilling: freezes water, thickens snow and dusts every surface with layers. */
public final class Chilling extends TerraformerProgram {
    ...
    private static boolean isSnowHere(Level world, BlockPos pos) {
        int prevY = pos.getY();
        pos = TerraformerBlockEntity.getFirstBlockFrom(world, pos, 16);
