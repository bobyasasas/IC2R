...
public final class RegistrationTests {
    ...
    static {
        ...
        FUNCTIONS.register(
                "trade_o_mat_owner", () -> EntityTickingTests.wrap(TradeOMatTests::ownerAndVisitorMenus));
        FUNCTIONS.register(
                "trade_o_mat_toggle_gate", () -> EntityTickingTests.wrap(TradeOMatTests::toggleNeedsOperator));
        ...
        FUNCTIONS.register("cable_family_specs", () -> CableFamilyTests::familySpecs);
        FUNCTIONS.register("cable_insulation_ladder", () -> CableFamilyTests::insulationLadder);
        FUNCTIONS.register("cable_waterlogged", () -> CableFamilyTests::waterloggedCable);
        FUNCTIONS.register("cable_connection_mask", () -> CableFamilyTests::connectionMask);
        ...
        FUNCTIONS.register(
                "remote_pairing_gate", () -> EntityTickingTests.wrap(RemoteTests::remotePairingGatesForeignRemotes));
        FUNCTIONS.register(
                "remote_launch_consumes", () -> EntityTickingTests.wrap(RemoteTests::remoteLaunchConsumesLinks));
