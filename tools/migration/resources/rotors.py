...
labels = {
    'en_us': {
        ...
        'ic2.rotor.shore': 'Shore: %s m', 'ic2.rotor.wind': 'Wind: %s', 'ic2.rotor.obstructions': 'Obstructed: %s', 'ic2.rotor.output': '%s KU/t', 'ic2.rotor.health': 'Rotor %s%%',
    ...
    'zh_cn': {
        ...
        'ic2.rotor.shore': '岸距：%s 米', 'ic2.rotor.wind': '风力：%s', 'ic2.rotor.obstructions': '遮挡：%s', 'ic2.rotor.output': '%s KU/t', 'ic2.rotor.health': '寿命 %s%%',
