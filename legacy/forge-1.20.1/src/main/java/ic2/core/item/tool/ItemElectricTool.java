...
public abstract class ItemElectricTool extends DiggerItem
    ...
    public static boolean consumeEnergy(
        ...
        if (entity == null) {
            isConsumed =
                    Util.isSimilar(
                            ElectricItem.manager.discharge(stack, amount, tier, true, false, false),
                            amount);
        } else {
    ...
    @Override
    public boolean hurtEnemy(ItemStack itemstack, LivingEntity entityliving, LivingEntity user) {
        return true;
    }
    ...
    public void inventoryTick(
            ItemStack itemstack, Level world, Entity entity, int i, boolean flag) {
    ...
    protected void initSound(LivingEntity entity, ItemStack stack) {
        ...
        if (this.idleSound == null && (idleEvent = this.getIdleSound(entity, stack)) != null) {
            this.idleSound =
                    IC2.soundManager.createSound(
                            entity, idleEvent, SoundSource.PLAYERS, entity, 1.0F, 1.0F);
        ...
        if (this.startSound == null && (startEvent = this.getStartSound(entity, stack)) != null) {
            this.startSound =
                    IC2.soundManager.createSound(
                            entity, startEvent, SoundSource.PLAYERS, entity, 1.0F, 1.0F);
        }
        ...
        if (this.stopSound == null && (stopEvent = this.getStopSound(entity, stack)) != null) {
            this.stopSound =
                    IC2.soundManager.createSound(
                            entity, stopEvent, SoundSource.PLAYERS, entity, 1.0F, 1.0F);
        }
    }
