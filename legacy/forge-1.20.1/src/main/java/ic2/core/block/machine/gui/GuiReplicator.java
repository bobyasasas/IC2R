...
public class GuiReplicator extends Ic2Gui<ContainerReplicator> {
    public GuiReplicator(
            ContainerReplicator container, Inventory playerInventory, Component title) {
        ...
        this.addElement(
                new ItemImage(this, 91, 17, () -> container.base.pattern)
                        .withTooltip(
                                () -> {
                                    ...
                                    String euReq =
                                            Util.toSiString(te.patternEu, 4)
                                                    + Component.translatable("ic2.generic.text.EU")
                                                            .getString();
        ...
        this.addElement(
                TextLabel.create(
                                ...
                                () -> {
                                    ...
                                    if (te.getMode() == TileEntityReplicator.Mode.STOPPED) {
                                        return Component.translatable(
                                                        "ic2.Replicator.gui.info.Waiting")
                                                .getString();
                                    }
                        ...
                        () ->
                                container.base.getMode() == TileEntityReplicator.Mode.STOPPED
                                        ? 15461152
                                        : 2157374,
                        false,
                        4,
