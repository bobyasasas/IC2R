...
public final class Ic2BlockTags {
    ...
    public static final TagKey<Block> COPPER_BLOCKS =
            create("c:copper_blocks", "forge:storage_blocks/copper");
    public static final TagKey<Block> GOLD_BLOCKS =
            create("c:gold_blocks", "forge:storage_blocks/gold");
    public static final TagKey<Block> IRON_BLOCKS =
            create("c:iron_blocks", "forge:storage_blocks/iron");
    public static final TagKey<Block> LEAD_BLOCKS =
            create("c:lead_blocks", "forge:storage_blocks/lead");
    public static final TagKey<Block> SILVER_BLOCKS =
            create("c:silver_blocks", "forge:storage_blocks/silver");
    public static final TagKey<Block> TIN_BLOCKS =
            create("c:tin_blocks", "forge:storage_blocks/tin");

    public static void init() {}

    private static TagKey<Block> create(String fabricName, String forgeName) {
        ResourceLocation id =
                ResourceLocation.parse(IC2.envProxy.isFabricEnv() ? fabricName : forgeName);
