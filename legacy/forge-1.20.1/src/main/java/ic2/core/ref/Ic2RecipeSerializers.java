...
import ic2.core.recipe.AdvRecipe.Serializer;
...
public final class Ic2RecipeSerializers {
    public static final RecipeSerializer<AdvRecipe> SHAPED = register("shaped", new Serializer());
    public static final RecipeSerializer<AdvShapelessRecipe> SHAPELESS =
            register("shapeless", new ic2.core.recipe.AdvShapelessRecipe.Serializer());
    ...
    public static final RecipeSerializer<JetpackAttachmentRecipe> JETPACK_ATTACHMENT =
            register(
                    "jetpack_attachment",
                    new ic2.core.item.armor.jetpack.JetpackAttachmentRecipe.Serializer());
    public static final WeightedMachineRecipeSerializer MACERATOR =
            register(
                    "macerator",
                    new WeightedMachineRecipeSerializer(Ic2RecipeTypes.MACERATOR, null));
