...
**当前为开发基础版本，尚未完成全部功能迁移。** 已验证发电机—导线—电炉链路及客户端区块恢复，接入风力动能机与五种转子、手动动能机、固体／流体加热器、电力加热器、电动动能机、斯特林与动能发电机、风力、水力、太阳能、地热、半流质发电机、铁炉、打粉机、提取机、压缩机、金属成型机、洗矿机、热能离心机、回收机、感应炉、九格工具箱、四档储能、四档变压器、罐装机四模式、17 个流体族与 20 个单元，扳手、锻造锤、切线钳、木龙头、矿石与橡胶树自然生成、橡胶木建筑部件、七种机器升级及部分合成配方；具体覆盖数、当前任务及剩余工作以迁移看板为准。
